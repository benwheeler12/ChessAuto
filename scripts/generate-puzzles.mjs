...
//
// Usage:
//   node scripts/generate-puzzles.mjs --label "My batch label"
//     [--in data/games.pgn] [--max 12] [--per-game 2]
//     [--shallow 80] [--deep 700]
//
// Output: a NEW immutable contract batch file under src/puzzles/ — each
// qualified position expands into one contract puzzle per mode it supports
// (pick-from-candidates, hidden-square, opponent-first, open-board).
